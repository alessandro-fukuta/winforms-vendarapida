...
namespace VendaRapida.Models
{
    public class Validacao
    {
        ...
        public string Formata_MesAno(string txt)
        {
            if (!string.IsNullOrEmpty(txt))
            {

                if (txt.Length == 5 && txt.Substring(2, 1) != "/" && txt.Substring(2,1) != "")
                {
                    txt = Convert.ToUInt64(txt).ToString(@"00\/00");
                }
            }
        ...
        public string Formata_Hora(string txt)
        {
            if (!string.IsNullOrEmpty(txt))
            {
        ...
        public string Formata_TelefoneFixo(string txt)
        {
            if (!string.IsNullOrEmpty(txt))
            {
                if (txt.Length == 10 && txt.Substring(7, 1) != "-")
                {
                    ...
                    if (txt.Length == 10 && txt.Substring(0, 1) != "(")
                    {
